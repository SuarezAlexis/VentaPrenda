...
namespace VentaPrenda.DAO.Concrete
{
    public class MovimientoDaoMySQL : IMovimientoDao
    {
        ...
        private static readonly string INSERT_SQL = "INSERT INTO Movimiento(Concepto,Importe,Descripcion,Fecha) VALUES(@Concepto,@Importe,@Descripcion,NOW()); SELECT LAST_INSERT_ID();";
        private static readonly string UPDATE_SQL = "UPDATE Movimiento SET Concepto = @Concepto, Importe = @Importe, Descripcion = @Descripcion WHERE ID = @ID";
